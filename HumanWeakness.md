...
- 礼貌待人;
  - 出行：
    - 步行：若与女性并行，则应让其右行；
    - 乘车：五座轿车中，驾驶位对角线的位置是一号位；
  - 递接：
    - 递物：面带微笑，端正身体，15°前倾，双手呈递；
      - 若为文字材料，应转换方向，使对方易于阅读；
    - 接物：面带微笑，起身双手接物；
      - 递接瓶装水：左手握瓶身$\frac{1}{3}$处，右手托瓶底；若对方为女性，则应当场拧开瓶盖后递接；
  - 联络：在朝序爵，在野序齿；
    - 打电话：
      - 和长辈打电话：长辈先挂断；
      - 和同辈打电话：呼叫者挂断；
    - 微信扫码添加好友：
      - 长辈展示二维码，我方扫描，既能使对方感到方便，又能给对方决定权；
  - 接待：
    - 室内面向门的位置为上座；
    - 送别对方至门外，待对方从我方实现中消失后，我方返回；
